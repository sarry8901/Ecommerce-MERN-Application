...
export const getSingleProductController = async (req, res) => {
  try {
    ...
    res.status(500).json({
      success: false,
      message: "Error in loading this product",
      error,
    });
  }
};
...
export const productPhotoController = async (req, res) => {
  try {
    ...
    res.status(500).json({
      success: false,
      message: "Error in loading photo of product",
      error,
    });
  }
};
...
export const productListController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      message: "Error While per page ctrl Products",
      error,
    });
  }
};
...
export const relatedProductController = async (req, res) => {
  try {
    ...
    res.status(200).send({
      success: true,
      message: "similar products loaded successfully",
      products,
    });
  } catch (error) {
